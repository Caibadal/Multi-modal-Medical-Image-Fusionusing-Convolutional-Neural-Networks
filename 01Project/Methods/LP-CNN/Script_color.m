...
[img1,map1]  = imread('/home/nora/Desktop/Datasets/Atlas_brain/Testing/MR/167.gif','Frames','all');   %anatomical image
img1 = ind2gray(img1,map1)
figure;imshow(img1);

[img2,map2]  = imread('/home/nora/Desktop/Datasets/Atlas_brain/Testing/SPECT/167.gif','Frames','all'); %functional image
...
folder = '/home/nora/Desktop/Datasets/Fused_images';
imwrite(uint8(imgf_RGB*255),'fuse_lp_cnn.png');
